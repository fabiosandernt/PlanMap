...
namespace PlanMap.Controllers
{
    public class PlantsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Lat,Long,Description")] Plant plant)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Lat,Long,Description")] Plant plant)
        {
            if (id != plant.Id)
            {
                return NotFound();
